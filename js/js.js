...
const Portfolio = (function () {
    ...
    function fillGallery(container) {
        ...
        for (let index = 0; index < 15; index++) {
            ...
            const img = createElement('img', [{ name: 'src', value: '/img/assets/0' + index + '.png' }]);
            item.addEventListener('click', () => {
                ...
                img.style.backgroundImage = 'url(/img/assets/0' + index + '.png)';
...
const Slider = (function () {
    ...
    function changeImg() {
        ...
        img.style.backgroundImage = 'url(img/assets/0' + IMG + '.png)';
