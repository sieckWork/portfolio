...
const Gallery = (function () {
    ...
    function createPage(container) {
        ...
        const imgSlider = createElement('img', [
            { name: 'src', value: 'img/illustrations_0' + idImage + '.png' },
        ...
        for (let index = 0; index < 9; index++) {
            ...
            const img = createElement('img', [{ name: 'src', value: 'img/illustrations_0' + index + '.png' }]);

            item.addEventListener('click', () => {
                idImage = index;
                sliderContainer.style.display = 'flex';
                imgSlider.src = 'img/illustrations_0' + index + '.png';
        ...
        nextContainer.addEventListener('click', () => {
            imgSlider.src = 'img/illustrations_0' + (idImage >= 8 ? idImage = 0 : ++idImage) + '.png';
        });

        backContainer.addEventListener('click', () => {
            imgSlider.src = 'img/illustrations_0' + (idImage <= 0 ? idImage = 8 : --idImage) + '.png';
        });
